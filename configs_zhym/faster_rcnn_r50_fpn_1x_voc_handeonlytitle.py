...
# dataset settings
dataset_type = 'HandeTableTitleWithOtherTextDataset'
data_root = 'data/HandeTableTitleWithOtherText/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_handetabletitlewithothertext-test'
load_from = None
resume_from = None
workflow = [('train', 1)]
