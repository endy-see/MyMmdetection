...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.6, nms=dict(type='nms', iou_thr=0.5), max_per_img=20)
    # soft-nms is also supported for rcnn testing
    # e.g., nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.05)
)
# dataset settings
dataset_type = 'HandeOnlyTableDataset'
data_root = 'data/HandeOnlyTable/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_handeonlytable'
load_from = None
resume_from = None
workflow = [('train', 1)]
