...
# dataset settings
dataset_type = 'DadiDetectionDataset'
data_root = 'data/DadiDetection/'
img_norm_cfg = dict(
...
# yapf:enable
# runtime settings
total_epochs = 600  # actual epoch = 4 * 3 = 12
dist_params = dict(backend='nccl')
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_dadi_detection'
load_from = None
resume_from = None
workflow = [('train', 1)]
